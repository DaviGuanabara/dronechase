...
from threatengage.environments.level4.exp03_vFinal_environment import (
    Exp03vFinalEnvironment as level4,
)


from src.core.rl_framework.utils.pipeline import (
    ReinforcementLearningPipeline,
    callbacklist,
    CallbackType,
)

from src.core.rl_framework.utils.directory_manager import DirectoryManager
...
def suggest_parameters(trial: Trial) -> dict:
    suggestions = {'hidden_1': trial.suggest_categorical('hiddens_1', [128])}

    suggestions['hidden_2'] = trial.suggest_categorical('hiddens_2', [256])
    suggestions['hidden_3'] = trial.suggest_categorical('hiddens_3', [512])
