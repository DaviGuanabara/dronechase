...
from loyalwingmen.environments.level2.pyflyt_level2_environment_modified import (
    PyflytL2EnviromentModified as Level2,
)
...
def main():
    ...
    study_name = f"level2_{n_timesteps_in_millions:.2f}M_14.01.2023_baysian_v_old_p2"
