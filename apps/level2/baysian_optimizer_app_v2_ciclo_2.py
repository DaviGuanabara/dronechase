...
def suggest_parameters(trial: Trial) -> dict:
    ...
    suggestions[f"hidden_{1}"] = trial.suggest_categorical(f"hiddens_{1}", [512])
    suggestions[f"hidden_{2}"] = trial.suggest_categorical(f"hiddens_{2}", [256])
    suggestions[f"hidden_{3}"] = trial.suggest_categorical(f"hiddens_{3}", [128])
    ...
    suggestions["batch_size"] = trial.suggest_categorical("batch_size", [64])
...
def rl_pipeline(
    ...
    path_lib = Path(
        # "C:\\Users\\davi_\\Documents\\GitHub\\PyFlyt\\apps\\level2\\output\\baysian_optimizer_app_v2\\08_01_2024_level2_2.00M_v2\\models_dir\\h[512, 128, 128]_f15_lr0.0001\\t0_PPO_r1482.58.zip"
        # "C:\\Users\\davi_\\Documents\\GitHub\\PyFlyt\\apps\\level2\\output\\baysian_optimizer_app_v2\\08_01_2024_level2_2.00M_v2\\models_dir\\h[256, 128, 128]_f15_lr0.0001\\t0_PPO_r1190.40.zip"
        # "C:\\Users\\davi_\\Documents\\GitHub\\PyFlyt\\apps\\level2\\output\\baysian_optimizer_app_v2_single\\09_01_2024_level2_2.00M_single\\Trial_5\\models_dir\\h[512, 256, 128]_f15_lr0.001\\t0_PPO_r1516.86.zip"
        "C:\\Users\\davi_\\Documents\\GitHub\\PyFlyt\\apps\\level2\\output\\baysian_optimizer_app_v2_single_modified\\12_01_2024_level2_1.00M_single_modified\\Trial_10\\models_dir\\h[512, 256, 128]_f15_lr0.001\\t0_PPO_r1472.57.zip"
    )
...
def main():
    ...
    study_name = f"12_01_2024_level2_{n_timesteps_in_millions:.2f}M_v2_best_of_level2_512_256_128_modified_2"
