...
from loyalwingmen.environments.level4.exp02_v4_environment import (
    Exp02V4Environment as level4,
)
...
def main():
    print("REMINDER: The exp02 v4 is air combat only and no cooperation.")
    n_trials = 20
    n_timesteps = 2_000_000
    n_timesteps_in_millions = n_timesteps / 1e6
    study_name = f"31_01_2024_level4_{n_timesteps_in_millions:.2f}M_exp02_v4"
