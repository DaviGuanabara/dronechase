...
from loyalwingmen.environments.level4.exp02_v2_environment import (
...
def rl_pipeline(
    ...
    path_lib = Path(
        ...
        "/Users/Davi/Library/CloudStorage/OneDrive-Pessoal/1. Projects/1. Dissertação/01 - Code/Experiment Results/Etapa 02/Ciclo 02/19_01_2023_level3_cicle_02_2.00M_v2_6_m_p2_600_calls/Trial_2/models_dir/h[128, 256, 512]_f15_lr0.0001/t2_PPO_r4427.63.zip"
    )
...
def main():
    print(
        "REMINDER: The exp02 v2 has some crucial fixes thaat must be applied into all experiments."
    )
    n_trials = 20
    n_timesteps = 2_000_000
    n_timesteps_in_millions = n_timesteps / 1e6
    study_name = (
        f"23_01_2024_level4_{n_timesteps_in_millions:.2f}M_exp02_v2_best_of_level3_p16"
    )
