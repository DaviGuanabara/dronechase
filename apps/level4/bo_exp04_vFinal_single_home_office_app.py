...
from loyalwingmen.environments.level4.exp04_vFinal_environment import (
...
def main():
    print("EXP04 - Air Combat - 1RL and 1BT")
    n_trials = 10
    n_timesteps = 2_000_000
    n_timesteps_in_millions = n_timesteps / 1e6
    study_name = (
        f"07_02_2024_level4_{n_timesteps_in_millions:.2f}M_exp04_vFinal_for_statistics"
    )
