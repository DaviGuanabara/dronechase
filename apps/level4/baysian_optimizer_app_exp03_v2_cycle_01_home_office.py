...
def main():
    print("REMINDER: The exp03 is air combat only.")
    n_trials = 2
    n_timesteps = 2_000_000
    n_timesteps_in_millions = n_timesteps / 1e6
    study_name = f"30_01_2024_level4_{n_timesteps_in_millions:.2f}M_exp03_best_of_level3_p01_complemento_do_dia_28"
