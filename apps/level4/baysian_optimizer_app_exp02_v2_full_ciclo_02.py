...
from loyalwingmen.environments.level4.exp02_v2_full_environment import (
    Exp02V2FullEnvironment as level4,
)
...
def rl_pipeline(
    ...
    print("Melhor do Level 4 ciclo 01: ")
    print("t3_PPO_r1019.33.zip - Trial 03")
    path_lib = Path(
...
def main():
    ...
    study_name = f"23_01_2024_level4_{n_timesteps_in_millions:.2f}M_exp02_v2_full_best_of_level4_cicle_01_p19"

    print("Baysian Optimizer App - V2 Full Cicle 2")
