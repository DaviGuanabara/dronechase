import pytest
from loyalwingmen.modules.quadcoters.components.sensors.lidar import LiDAR, CoordinateConverter, Channels, QuadcopterType  # adjust the import path accordingly
import numpy as np
