...
from loyalwingmen.environments.level4.exp03_vFinal_environment import (
...
def suggest_parameters(trial: Trial) -> dict:
    ...
    suggestions["learning_rate"] = 10 ** trial.suggest_int("exponent", -4, -4)
    suggestions["batch_size"] = trial.suggest_categorical(
        "batch_size", [2048]  # [32, 64, 128, 256, 512, 1024]
    )
...
def main():
    ...
    study_name = (
        f"08_02_2024_level4_{n_timesteps_in_millions:.2f}M_exp03_vFinal_single_last_p2"
    )
