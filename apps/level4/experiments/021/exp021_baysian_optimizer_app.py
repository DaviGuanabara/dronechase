...
def directories(study_name: str):
    ...
    output_folder = os.path.join("exp021_output", app_name, study_name)
...
def main():
    ...
    study_name = f"{n_timesteps_in_millions:.2f}M_dome_radius_20_03.12.2023"
