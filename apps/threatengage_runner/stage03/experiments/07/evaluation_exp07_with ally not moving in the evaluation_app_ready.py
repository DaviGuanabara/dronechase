    ...
    configuration["drivers"] = [
        {
            "type": "nn",
            "name": "nn_1",
            "path": "C:\\Users\\davi_\\OneDrive\\1. Projects\\1. Dissertação\\01 - Code\\Experiment Results\\Etapa 03\\Treinamento - 1RL 1BT PARADO - EXP04\\01_02_2024_level4_2.00M_exp04_vFinal\\Trial_5\\models_dir\\h[128, 256, 512]_f15_lr0.0001\\t5_PPO_r13132.91.zip",
        },
        {
            "type": "nothing",
            "name": "not moving",
...
if __name__ == "__main__":
    ...
    # excel_filename = "evaluation_04.02.2024_exp07_1RL_1NOT_MOVING_episode_info.xlsx"
