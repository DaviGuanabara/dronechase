...
from threatengage.modules.utils.displaytext import log
import numpy as np
import pstats
...
# env = Monitor(Level1(GUI=False, rl_frequency=30))
# check_env(env)
...
def on_avaluation_step():
    ...
    rl_frequency = 30
    env_fns = [
        lambda: Level1(GUI=False, rl_frequency=rl_frequency) for _ in range(n_envs)
    ]
