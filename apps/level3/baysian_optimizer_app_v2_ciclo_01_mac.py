...
def rl_pipeline(
    ...
    print("Melhor do Level 2: Trial 3")
    # print("level2_2.00M_14.01.2023_baysian_v_old_v2_multi_topology_p3_mac - Trial 04")
    path_lib = Path(
        "/Users/Davi/Library/CloudStorage/OneDrive-Pessoal/1. Projects/1. Dissertação/01 - Code/Experiment Results/Etapa 01/level2_2.00M_14.01.2023_baysian_v_old_v2_multi_topology_p3_mac/Trial_4/models_dir/h[128, 256, 512]_f15_lr0.001/t0_PPO_r8861.86.zip"
...
def main():
    ...
    study_name = f"18_01_2023_level3_{n_timesteps_in_millions:.2f}M_v2_best_of_level2_p3_6m_reward_fixed_mac"
