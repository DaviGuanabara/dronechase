...
from ..components.tasks_management.test.test_tasks_dispatcher import TESTTasksDispatcher
...
class TestFSML4Enviroment(Env):
    ...
    def init_components(self, dome_radius, GUI):
        ...
        self.task_progression = TaskProgression(
            TESTTasksDispatcher.test_fsm_level4_task(
