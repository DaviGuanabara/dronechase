...
from threatengage.environments.level4.components

from threatengage.environments.level4.components.simulation.level4_simulation import L4AviarySimulation
from ...components.entities_management.quadcopter_manager import (
    QuadcopterManager,
    Quadcopter,
)
...
from threatengage.environments.level4.components.tasks_management.stages import L3Stage1 as Stage1
...
class PyflytL4Enviroment(Env):
    ...
    def init_components(self, dome_radius, GUI):
        ...
        self.task_progression = TaskProgression(
            [Stage1(self.simulation, self.quadcopter_manager, dome_radius)]
        )
