...
class EvaluationAirCombatTask(Task):
    def __init__(
        self,
        # simulation,
        ...
        print("Evaluation Air Combat Task - init")

        self.dome_radius = dome_radius
        self.entities_manager = entities_manager

        self.init_constants(num_pursuers)
        self.init_globals()
    ...
    def init_constants(self, num_pursuers: int):
    ...
    def on_episode_end(self):
        ...
        raise Exception("Esse trecho de código parece redundante. o init constants necessita de self.PERSUERS. Devo corrigir ?")
        self.init_constants()
        self.init_globals()
