...
class Exp05_Cooperative_Only_2_RL_Task(Task):
    def __init__(
        self,
        # simulation,
        ...
        print("Exp04 - Only Cooperation BT Stopped - init")

        self.dome_radius = dome_radius
        self.entities_manager = entities_manager

        self.update_model_path(model_path)
    ...
    def drive_lw_rl_agent(self):
        driver = self.lw_driver
