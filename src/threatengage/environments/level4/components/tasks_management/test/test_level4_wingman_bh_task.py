...
class TEST_LEVEL4_WNGMAN_BH_TASK(Task):
    def __init__(
        self,
        # simulation,
        ...
        print("TEST_LEVEL4_WNGMAN_BH_TASK")
    ...
    def init_constants(self):
        ...
        self.MAX_STEP = 1_000  # 300 calls = 20 seconds for rl_frequency = 15
    ...
    def replace_invaders(self):
        ...
        positions = (
            self.invaders_positions
        )  # self.generate_positions(len(invaders), self.dome_radius / 2)
    ...
    def spawn_invader_squad(self):
        ...
        positions = np.array(
            [[0, 0, 3], [0, 3, 2], [0, -1, 1]]
        )  # self.generate_positions(self.NUM_INVADERS, self.dome_radius)  # /2
    ...
    def spawn_pursuer_squad(self):
        ...
        positions = np.array(
            [[2, 0, 2]]
        )  # self.generate_positions(self.NUM_PURSUERS, 2)
