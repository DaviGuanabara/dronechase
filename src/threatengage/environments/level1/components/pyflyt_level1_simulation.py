...
from threatengage.modules.quadcoters.components.base.quadcopter import Quadcopter
...
class AviarySimulation(bullet_client.BulletClient):
    ...
    def __init__(
        ...
        self.updates_per_step = int(self.physics_hz / self.ctrl_hz)
...
def on_avaluation_step():
    ...
    simulation = AviarySimulation(render=True)
