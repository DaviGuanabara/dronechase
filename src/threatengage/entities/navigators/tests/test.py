...
from threatengage.environments.level4.components.entities_management.navigators.loitering_munition_navigator import (
...
def gen_test_offset(
    ...
    lw_ids = list(range(num_lw))  # random.sample(range(1, 11), num_lw)
    lm_ids = list(
