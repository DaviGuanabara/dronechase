...
uses RL agent to control the first pursuer. The second LW uses a copy of the model of the first pursuer.
...
class Exp05_vFinal_Task(Task):
    def __init__(
        ...
        print("Exp05 - V2 - Only Cooperation ALLY RL - init")
